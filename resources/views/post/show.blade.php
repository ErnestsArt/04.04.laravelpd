                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="min-w-fit min-h-fit my-3">
                        <a href="{{ route('posts.edit', $post->id) }}"
                            class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900">Edit</a>
                    </div>
                    <div class="min-w-fit min-h-fit my-3">
                    ...
                    <form action="{{ route('comments.store', $post->id) }}" method="post">
                        ...
                        <button
                            type="submit"
                            class="inline-flex items-center mt-2 px-4 py-2 bg-blue-600 border border-transparent rounded-md shadow-sm text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">Add Comment</button>
                    </form>
                </div>
            </div>
        </div>
